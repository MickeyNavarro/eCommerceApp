...
//December 8, 2018
//This is my own work.
//processes the form to create a sales report
...
$orders = $orderbs->getOrdersBetweenDatesForProductReport($sdate, $edate);
...
include '_displayProductSalesReportTable.php';